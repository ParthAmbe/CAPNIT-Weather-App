...
title_label = tk.Label(root, text="Weather App", font=("Arial", 20, "bold"), bg="#ADD8E6", fg="#000080")
title_label.pack(pady=10)

# Entry widget for city input
city_entry = tk.Entry(root, width=20, font=("Arial", 14), bg="#F0F8FF", fg="#000080")
city_entry.pack(pady=10)

# Button to get weather data
get_weather_button = tk.Button(root, text="Get Weather", font=("Arial", 14, "bold"), bg="#4682B4", fg="white", command=get_weather)
get_weather_button.pack(pady=5)

# Label to display the weather information
result_label = tk.Label(root, text="Enter a city and press 'Get Weather'.", font=("Arial", 14), justify="left", bg="#ADD8E6", fg="#000080")
